...
class TestFeedPage:
    ...
    def test_click_on_order_opens_order_details(self, driver):
        ...
        driver.get(TestData.MAIN_URL + TestData.FEED_URL)
    ...
    def test_orders_from_history_shown_on_order_feed_page(self, driver):
        feed_page = FeedPage(driver)
    ...
    def test_create_order_increases_common_order_counter_value(self, driver):
        feed_page = FeedPage(driver)
        login_page = LoginPage(driver)
        constructor_page = ConstructorPage(driver)
        header_page = HeaderPage(driver)
    ...
    def test_create_order_increases_daily_order_counter_value(self, driver):
        feed_page = FeedPage(driver)
        login_page = LoginPage(driver)
        constructor_page = ConstructorPage(driver)
        header_page = HeaderPage(driver)
    ...
    def test_created_order_displayed_on_in_progress_section(self, driver):
        """
